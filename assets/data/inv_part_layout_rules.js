/** Part layout rules: selection by inv+rarity, exclusions, weights, per-slot min/max. */
(function(){
...
window.INV_PART_SELECTION_DATA = PART_SELECTION_DATA;
window.INV_PART_EXCLUSION_TAGS = EXCLUSION_TAGS;
window.INV_PART_WEIGHTS = PART_WEIGHTS;
window.INV_PART_MIN_MAX_SLOTS = MIN_MAX_PARTS;
})();
